...
- **Scripts:** multiple issues when running shell scripts i.e. 'bash', 'batch', and 'powershell' 
- **Commands:** clicking a tree item row when configured to 'open' the source taskfile at the task definition location throws a json circular structure error 

### Documentation

- **Readme:** content updates for v3

## Version 3.0.1 (November 9th, 2025)

### Features

- initial version 3 release preview

## Version 2.13.15 (December 23rd, 2022)
